...
public class eece extends JFrame implements ActionListener{
	...
	new eece().setVisible(true);
    }
    
    public void Book() {
	try {
            conn con = new conn();
            String sql = "select * from eece";
...
//	contentPane.add(b2);
	...
	JLabel l1 = new JLabel("EECE Dept Book Details");
