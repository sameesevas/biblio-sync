...
//	contentPane.add(b2);
	...
	JLabel l1 = new JLabel("CSE Dept Book Details");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String sql = "select * from cse where concat(name, book_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		table.setModel(DbUtils.resultSetToTableModel(rs));
            ...
            if(ae.getSource() == b2){
                String sql = "delete from cse where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
