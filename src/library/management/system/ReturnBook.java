...
public class ReturnBook extends JFrame implements ActionListener{
    ...
    private JTextField textField_6,t1;
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    ...
                    textField_4.setText(rs.getString("level"));
                    textField_5.setText(rs.getString("course"));
		...
		rs.close();
            ...
            if(ae.getSource() == b2){
                String sql = "insert into returnBook(book_id, student_id, bname, sname,level, course, dateOfIssue, dateOfReturn) values(?, ?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, textField.getText());
